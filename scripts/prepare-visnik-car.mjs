...
const io = new NodeIO();
const d = await io.read("../assets-source/visnik/car-raw.glb");
await MeshoptSimplifier.ready;
await d.transform(
  dedup(),
  weld(),
  simplify({ simplifier: MeshoptSimplifier, ratio: 0.6, error: 0.0005 }),
  prune(),
);
d.getRoot().setExtras({
  author: "visnik",
  source: "https://blendswap.com/blend/10625",
