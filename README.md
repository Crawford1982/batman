...
The original `../bat-wing_1989.glb` is untouched. `src/models/batwing.glb` disconnects the separately named BaseInner, BaseOuter and BatLogo display objects from the scene. Aircraft geometry is preserved. Embedded metadata credits The WarVet under CC BY 4.0; see public/credits.html. Audio, city, sky, snow and moon texture are generated by the code. Music is original synthesized minor-key ambience, not a film soundtrack.
